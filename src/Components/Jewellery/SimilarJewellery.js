...
const SimilarJewellery = ({
  ...
  return (
    <Container>
      ...
      >
        {jewellerySimillarProducts.map((jewelleryProduct, index) => (
          <SwiperSlide>
            <div
              ...
              <div className="jewellery_box_wrapper">
                <div className="jewellery_img_wrapper">
                  ...
                  <div className="wishlist_icon">
                    ...
                    >
                      <img
                        src={jewelleryProduct.Is_Like ? LikeImage : HeartIcon}
                        alt="like"
                      />
                    </Button>
                  </div>
                      ...
                      <div className="button_botttom_wrap">
                        <div className="price ">
                          <h6 className="m-0 ff_Mulish">
                            ...
                            {/* {jewelleryProduct.Setting_Rate
                              ? Number(
                                  jewelleryProduct.Setting_Rate || 0,
                                )?.toFixed(2)
                              : '0.00'} */}
                          </h6>
                        </div>
...
export default memo(SimilarJewellery);
