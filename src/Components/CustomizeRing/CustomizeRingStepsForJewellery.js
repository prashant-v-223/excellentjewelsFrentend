...
const CustomizeRingStepsForJewellery = ({
  dispatch,
  chooseStepSelect,
  setChooseStepSelect,
  ...
  const stepOneDiamondWiseSetting = useMemo(() => {
    return (
      <Col xs={4}>
        ...
        >
          <div className="step_text ff_Mulish">
            <span>1</span>
      ...
      <Col xs={4}>
        ...
        >
          <div className="step_text">
            ...
            <div className="step_price_detail ff_Mulish">
              <h3 className="ff_Mulish mb-0">
                Choose Your Diamond
...
export default memo(CustomizeRingStepsForJewellery);
